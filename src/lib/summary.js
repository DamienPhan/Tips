...
export function summary(missions, shifts, period, refDate = new Date()) {
  ...
  // Heures sup "normales" (jour travaillé classique) et heures d'un jour OFF travaillé sont gardées
  // séparées ici pour l'affichage/les exports (voir payroll.js pour la fusion utilisée en paie).
