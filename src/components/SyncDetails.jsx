...
// Diagnostic en lecture seule : liste les missions/shifts locaux pas encore confirmés synchronisés
// (pending/error/pending-delete) avec le message d'erreur stocké par flush()/flushShifts() en cas
// d'échec (syncError) — sert à comprendre depuis le téléphone pourquoi le compteur "en attente" de
// SyncBar ne redescend pas, sans avoir besoin d'un inspecteur web branché sur un Mac.
